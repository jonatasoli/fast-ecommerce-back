...
def upgrade():
    ...
    op.add_column('product', sa.Column('category_id', sa.Integer(), server_default='1', nullable=True))
    op.add_column('product', sa.Column('discount', sa.Integer(), nullable=True))
    op.add_column('product', sa.Column('quantity', sa.Integer(), server_default='9999', nullable=True))
