...
def upgrade():
    ...
    op.add_column('product', sa.Column('show_discount', sa.Boolean(), server_default='0', nullable=True))
    op.add_column('product', sa.Column('showcase', sa.Boolean(), server_default='0', nullable=True))
